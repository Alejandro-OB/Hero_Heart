...
public class cazador : MonoBehaviour
{
    ...
    public void Disparar()
    {
        ...
        if (transform.localScale.x > 0 && spriteRenderer.flipX == false) direccionDisparo = Vector3.right;
        else
        {
    ...
    public void ProducirSonidoDisparo()
    {
        Destroy(Instantiate(sonidoDisparo, transform.position, Quaternion.identity), 1f);
    }
}
